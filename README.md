...
- shared-memory parallelism: multi-threading with OpenMP (intermediate level)
- architecture of an HPC cluster, from nodes to network and storage
- distributed-memory parallelism with MPI (intermediate level)
